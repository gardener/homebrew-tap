class GardenctlV2 < Formula
  ...
  if OS.mac?
    if Hardware::CPU.arm?
      url "https://github.com/gardener/gardenctl-v2/releases/download/v3.0.13/gardenctl_v2_darwin_arm64"
      sha256 "abc"
    else
      url "https://github.com/gardener/gardenctl-v2/releases/download/v3.0.13/gardenctl_v2_darwin_amd64"
      sha256 "abc"
    end
  elsif OS.linux?
    url "https://github.com/gardener/gardenctl-v2/releases/download/v3.0.13/gardenctl_v2_linux_amd64"
    sha256 "anc"
